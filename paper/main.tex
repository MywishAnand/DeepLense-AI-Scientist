...
${\sim}4.4\times$ fewer parameters; the planner closes train/val gaps of 0.18--0.23
...
accuracy (0.8706 vs 0.8100) with ${\sim}4.4\times$ fewer parameters, same LLM,
...
\begin{table}[t]
  ...
  ${\sim}4.4\times$ fewer parameters; test tracks validation for both arms.}
  \label{tab:final}
  \centering
  \small
